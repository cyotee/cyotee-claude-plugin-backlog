...
1. **Check tasks/INDEX.md exists:**
   ...
   if [[ ! -f "tasks/INDEX.md" ]]; then
     echo "No tasks/INDEX.md found. Run /init first."
     exit 1
   fi
   ```
...
- `/launch <ID>` - Creates worktrees with new naming convention
- `/complete <ID>` - Completes and removes worktrees
