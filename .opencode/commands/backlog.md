...
- `/launch <ID>` - Launch agent worktree for a task
- `/review <ID>` - Transition task to review mode
- `/complete <ID>` - Complete and merge a task
- `/prune` - Archive completed tasks
- `/list` - List active worktrees
- `/design` - Create a new task
- `/review` - Review task definitions

## Error Handling

- **No tasks/ directory:** "Run /init to set up task management"
- **No design.yaml:** "Run /init to configure the repository"
